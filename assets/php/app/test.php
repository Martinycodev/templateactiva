		...
		else
		{
			...
			if($SERVICIO == "1")
			{
				...
				if(!isset($_GET['BUSQUEDA']) || empty($_GET['BUSQUEDA']))
				{
					...
					$consulta = "SELECT url_foto, categoria, nombre_negocio, direccion, telefono_local, horario, horario_cocina, facebook,maps,url_carta FROM BARES";
				...
				else
				{
                    ...
                    $consulta = "SELECT url_foto, categoria, nombre_negocio, direccion, telefono_local, horario, horario_cocina, facebook,maps,url_carta FROM BARES WHERE categoria LIKE '%$BUSQUEDA%' OR nombre_negocio LIKE '%$BUSQUEDA%'";
			...
			elseif($SERVICIO == "2")
			{
				...
				if(!isset($_GET['BUSQUEDA']) || empty($_GET['BUSQUEDA']))
				{
					...
					$consulta = "SELECT url_foto, categoria, nombre_negocio, direccion, telefono_local, horario, horario_cocina, facebook,maps,url_carta FROM BARES WHERE servicio>=$SERVICIO";
				...
				else
				{
					...
					$consulta = "SELECT url_foto, categoria, nombre_negocio, direccion, telefono_local, horario, horario_cocina, facebook,maps,url_carta FROM BARES WHERE servicio>=$SERVICIO AND (categoria LIKE '%$BUSQUEDA%' OR nombre_negocio LIKE '%$BUSQUEDA%')";
		...
		else
		{
			...
			if($SERVICIO == "1")
			{
				...
				if(!isset($_GET['BUSQUEDA']) || empty($_GET['BUSQUEDA']))
				{
					...
					$consulta = "SELECT url_foto, categoria, nombre_negocio, direccion, telefono_local, horario, horario_cocina, facebook,maps,url_carta FROM BARES WHERE id_localidad=$ID_LOCALIDAD";
				...
				else 
				{
					...
					$consulta = "SELECT url_foto, categoria, nombre_negocio, direccion, telefono_local, horario, horario_cocina, facebook,maps,url_carta FROM BARES WHERE id_localidad=$ID_LOCALIDAD AND (categoria LIKE '%$BUSQUEDA%' OR nombre_negocio LIKE '%$BUSQUEDA%')";
			...
			elseif($SERVICIO == "2")
			{
				...
				if(!isset($_GET['BUSQUEDA']) || empty($_GET['BUSQUEDA']))
				{
					...
					$consulta = "SELECT url_foto, categoria, nombre_negocio, direccion, telefono_local, horario, horario_cocina, facebook,maps,url_carta FROM BARES WHERE id_localidad=$ID_LOCALIDAD AND servicio>=$SERVICIO";
				...
				else 
				{
					...
					$consulta = "SELECT url_foto, categoria, nombre_negocio, direccion, telefono_local, horario, horario_cocina, facebook,maps,url_carta FROM BARES WHERE id_localidad=$ID_LOCALIDAD AND servicio>=$SERVICIO AND categoria LIKE '%$BUSQUEDA%' OR nombre_negocio LIKE '%$BUSQUEDA%'";
